# -*- coding: UTF-8 -*-
"""
打包脚本：把 siwu-mcs-manager 插件源码打包为 zip，用于 AstrBot 网页端上传安装。

版本号自动读取自 metadata.yaml 中的 version，输出 dist/siwu-mcs-manager-<version>.zip
